 ...
 * 公布出去的死讯：谁出局了、坐几号。
 *
 * 不带死因——法官不公布死因，死因是上帝视角字段，唯一去处是 PlayerState.deathCause。
 * 口径见 visibility.ts。
 */
...
/** 天亮时的公布结果。deaths 为空数组就是平安夜，不必另设标志位。 */
 ...
 *
 * 只认「谁死了、怎么死的」，不算夜间刀法——夜里发生了什么由夜间流程决定，
 * 这里负责的是让白天看到的结果与状态一致。白天不再有人加入死者名单，
 * 所以死亡天数就是当前天数。
 */
